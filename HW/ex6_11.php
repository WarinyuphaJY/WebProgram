<?php
    if (isset($_GET['submit'])) {
        ...
        echo "<br>";
        echo "<a href='ex6_11.php'> <big>Back </big></a>";
        } 
        else {
        ...
        <html> 
            ...
            <body>
            <form method="get" action="ex6_11.php">
            <table border="1" align="center" width="500">
                ...
                <tr>
                    ...
                    <td><input type="number" name="hw" size="15" value="" min="0" max="30"/> </td>
                </tr>
                    <td>Enter Midterm : </td>
                    <td><input type="number" name="midterm" size="15" value="" min="0" max="35"/></td>
                </tr>
                </tr>
                    <td>Enter final : </td>
                    <td><input type="number" name="final" size="15" value="" min="0" max="35"/></td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
