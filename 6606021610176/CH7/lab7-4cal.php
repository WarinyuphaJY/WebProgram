...
<body>
    ...
    if ( isset($_GET['data']) && isset($_GET['ch']) ) {
        ...
        echo "ตัวแปร \$data มีจำนวนคำทั้งหมด = '" . str_word_count($data) . "'<br>";
        echo "ตัวแปร \$data ตัด strchr เหลือจำนวน = '" . strchr($data,$ch) . "'<br>";
        echo "ตัวแปร \$data ตัด substr เริ่ม 10 จำนวน 7 ตัว ='".substr($data,10,7)."'<br>";
